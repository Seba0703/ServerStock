...
public class Consts {
    ...
    final static String FROM_DATE = "desde";
    final static String TO_DATE = "hasta";
    ...
    final static String RED = "rojo";
    final static String YELLOW = "amarillo";
    final static String WHITE = "blanco";
